...
echo '<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #add8f7; sticky-top py-2">
      <a class="navbar-brand" href="index.php" style="font-size:65px; font-family: Brush Script MT,cursive;">'.$systemName.'</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewbookList.php?catid=' .$row['categorieId']. '">' .$row['categorieName']. '</a>';
            }
            echo '</div>
          </li>
          <li class="nav-item">
        ...
        <form method="get" action="/OnlineBookDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
