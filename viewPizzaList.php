...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `pizza` WHERE bookCategorieId = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 17rem;">
                            <img src="img/book-'.$bookId. '.jpg" class="card-img-top" alt="image for this book" width="200px" height="370px">
                            <div class="card-body">
                            ...
                            echo '</form>                            
                                <a href="viewPizza.php?bookId=' . $bookId . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
