...
<body>
    ...
    <div>
        <a href="index.php">
        <button style="font-size:20px; font-weight:1000; float: right; ">X<i class="fa fa-close"></i></button>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `book` WHERE bookCategorieId = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        ...
                        <a href="viewbook.php?bookId=' . $bookId . '"> <img src="img/book-'.$bookId. '.jpg" class="card-img-top" alt="image for this book" width="200px" height="370px"></a>
                            <div class="card-body">
                                <h5 class="card-title">' . substr($bookName, 0, 20). '...</h5>
                                <p>By ' . substr($writer,0,30). '</p>
                                <h6 style="color: #ff0000">Rs. '.$bookPrice. '/-</h6>
                                <p class="card-text">' . substr($bookDesc, 0, 19). '...</p>   
