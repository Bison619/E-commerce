...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        <?php
            $bookId = $_GET['bookId'];
            $sql = "SELECT * FROM `pizza` WHERE bookId = $bookId";
        ...
        echo  '<div class="col-md-4">
                <img src="img/book-'.$bookId. '.jpg" width="200px" height="350px">
            </div>
            <div class="col-md-8 my-4">
                ...
                <div class="mx-4">
                    <a href="viewPizzaList.php?catid=' . $bookCategorieId . '" class="active text-dark">
